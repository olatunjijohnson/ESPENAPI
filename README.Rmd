...
directly from the [ESPEN portal](https://espen.afro.who.int) API —
no browser, no manual exports.
...
- All **7 NTD disease types**: lf, oncho, loa, sch, sth, trachoma, coendemicity
...
Request a free API key from <https://espen.afro.who.int>, then store
it in your `.Renviron`:
...
covering forecast data, pagination, column filtering, and worked examples.
